...
public class RMF_RadialMenu : MonoBehaviour {
    ...
    [Tooltip("With this option visual anchors will be rendered along the outer edge of a widgit.")]
    public bool useVisualAnchors = true;
    ...
    //TODO needs to change completely!
